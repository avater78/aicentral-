        ...
        <div className="flex items-center justify-between h-16 gap-4">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2">
            ...
            <button
              ...
              className={`p-2 rounded-xl border transition-all md:hidden cursor-pointer shadow-sm ${
                showMobileSearch
            ...
            <div className="relative">
              <button
                ...
                className={`flex items-center gap-1.5 px-2.5 py-2 rounded-full border transition-all text-xs font-semibold cursor-pointer shadow-md group ${
                  darkMode
              ...
              {showLangDropdown && (
                <div className={`absolute right-0 mt-2 w-64 max-h-80 overflow-y-auto border rounded-2xl shadow-2xl overflow-hidden z-50 p-2 backdrop-blur-2xl custom-scrollbar animate-in fade-in zoom-in-95 duration-150 ${
                  darkMode
            ...
            {onOpenShare && (
              <button
                onClick={onOpenShare}
                className="p-2.5 rounded-xl bg-indigo-500/10 hover:bg-indigo-500/20 border border-indigo-500/30 text-indigo-400 hover:text-indigo-600 transition-all shadow-sm hover:scale-105 cursor-pointer"
            ...
            <button
              ...
              className={`relative p-2.5 rounded-xl border transition-all shadow-sm cursor-pointer group ${
                darkMode
            ...
            >
              <Bookmark className="w-4 h-4 text-cyan-500 fill-cyan-500/20 shrink-0" />
              {savedCount > 0 && (
                <span className="absolute -top-1 -right-1 min-w-[18px] h-[18px] px-1 rounded-full bg-cyan-500 text-[10px] font-extrabold text-white flex items-center justify-center">
                  {savedCount}
                </span>
              )}
            </button>
            ...
            >
              ...
              {unreadNotificationsCount > 0 && (
                <span className="absolute -top-1 -right-1 flex h-4 w-4">
                  ...
                  <span className="relative inline-flex rounded-full h-4 w-4 bg-cyan-500 text-[9px] font-extrabold text-white items-center justify-center border border-white">
                    {unreadNotificationsCount}
                  </span>
                </span>
              )}
            ...
            >
              {darkMode ? (
                ...
                <Sun className="w-4 h-4 text-white fill-current" />
              )}
            </button>
            ...
            {currentUser ? (
              <div className="flex items-center gap-2 pl-1">
                <button
                  ...
                  className="p-1 rounded-full bg-white/5 hover:bg-white/10 border border-white/10 hover:border-cyan-500/40 cursor-pointer transition-all shrink-0"
                ...
                <button
                  onClick={onLogout}
                  className="p-2 rounded-xl bg-gradient-to-r from-red-500/20 to-rose-600/20 hover:from-red-500/30 hover:to-rose-600/30 text-rose-400 hover:text-rose-200 border border-red-500/40 hover:border-red-400 shadow-md shadow-red-500/10 transition-all hover:scale-105 shrink-0 cursor-pointer"
                  title={t('logout')}
                >
              ...
              <button
                ...
                className="px-4 py-2 rounded-full bg-cyan-500 hover:bg-cyan-400 text-slate-950 font-bold text-xs flex items-center gap-1.5 shadow-md shadow-cyan-500/20 transition-all hover:scale-105 shrink-0"
              >
